...
import { BenchmarkRNG } from "../BenchmarkMeasure";
...
let plainText: string = "Rebellious subjects, enemies to peace,\n\
...
Once more, on pain of death, all men depart.";
 ...
 const md5Output: string = hex_md5(plainText);
 const expected: string = "a831e91e0f70eddcb70dc61c6f82f6cd";
...
const benchmarkRun = new BenchmarkRun('crypto-md5', true, true, Md5Run,undefined,undefined,undefined,22)
benchmarkRun.run()
